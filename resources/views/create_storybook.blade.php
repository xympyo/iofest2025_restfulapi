    ...
    <div x-data="storybookForm()" class="flex h-screen w-full overflow-hidden bg-[#292838]">
        ...
        <div class="w-full max-w-xl h-full overflow-y-auto px-8 py-10 flex flex-col gap-6">
            ...
            <div class="mb-4">
                ...
                <div x-show="bgOpen" x-transition class="mt-2 bg-[#bdb6e6]/30 rounded-lg p-4">
                    <label
            ...
            <div class="mb-4">
                ...
                <div x-show="profileOpen" x-transition class="mt-2 bg-[#bdb6e6]/30 rounded-lg p-4">
                    <label
                        ...
                        <template x-if="profilePreview">
                            <img :src="profilePreview" alt="Profile Preview" class="object-cover w-20 h-20 rounded-full" />
                        </template>
                    </label>
                </div>
            </div>
        ...
        function storybookForm() {
            return {
                ...
                uploadBg(e) {
                    ...
                    reader.onload = (ev) => {
                        this.bgPreview = ev.target.result;
                        sessionStorage.setItem('sb_bg', ev.target.result);
                    };
                ...
                uploadProfile(e) {
                    ...
                    const reader = new FileReader();
                    reader.onload = (ev) => {
                        this.profilePreview = ev.target.result;
                        sessionStorage.setItem('sb_profile', ev.target.result);
                    };
                    reader.readAsDataURL(file);
                },
                init() {
