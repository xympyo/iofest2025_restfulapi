    ...
    <div class="lg:w-1/2 flex flex-col justify-center items-center bg-white dark:bg-[#f8f9fa] p-8">
        <div class="w-full max-w-md">
            ...
            <div class="text-center text-[#23232B] mb-6">
                Don’t have an account? <a href="#" class="underline text-[#23232B] hover:text-[#F8B6B6]">Create one in your TappyTale Application!</a><br>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" required class="w-full border-b-2 border-[#23232B] bg-transparent py-2 px-1 focus:outline-none focus:border-[#F8B6B6] transition placeholder:text-gray-400" placeholder="Enter your password">
                </div>
                <button type="submit" class="w-full py-3 bg-[#23232B] text-white rounded-lg font-semibold text-lg hover:bg-[#F8B6B6] hover:text-[#23232B] transition">Login Now</button>
                <button type="button" class="w-full py-3 border border-gray-300 rounded-lg flex items-center justify-center gap-2 text-[#23232B] font-semibold text-lg bg-white hover:bg-gray-100 transition">
            ...
            <div class="text-right mt-4">
                ...
                <a href="{{ url('forgot_password') }}" class="text-[#23232B] underline hover:text-[#F8B6B6]">Click here</a>
            </div>
        </div>
    </div>
</div>
